...
class Http
{
    ...
    protected function runWithRequest(Request $request)
    {
        ...
        // 加载全局中间件(应用下的中间件配置 app/middleware.php)
        $this->loadMiddleware();
        ...
        // 这里比较隐晦, 初学者代码阅读起来会比较难懂, 也是TP6中间件实现的精髓, 实际上是使用了管道来触发中间件.
        // 核心是以Request对象为传递参数一层层调用中间件, 并且最终调用dispatchToRoute方法.
    ...
    {
        //判断配置文件是否已启用路由, 并返回路由加载执行方法.
        //注意这里只是返回一个匿名函数, 并未执行加载.
